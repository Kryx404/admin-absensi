...
export default function UserAddressCard() {
    ...
    const handleSave = async () => {
        ...
        try {
            console.log("Updating address:", user.id, formData);
            ...
            if (response.success) {
                ...
                closeModal();
                // Refresh data di komponen
                window.location.reload();
            } else {
                setError(response.message || "Gagal update alamat");
            }
        } catch (err) {
            console.error("Update address error:", err);
            setError("Terjadi kesalahan saat update alamat");
        } finally {
            setLoading(false);
        }
    };
